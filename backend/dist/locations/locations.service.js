...
let LocationsService = class LocationsService {
    cityRepository;
    areaRepository;
    constructor(cityRepository, areaRepository) {
    ...
    async detectCity(lat, lon) {
        ...
        if (cities.length === 0) {
            throw new common_1.NotFoundException('No cities available in database.');
        }
        let bestCity = null;
...
exports.LocationsService = LocationsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(entities_1.City)),
    __param(1, (0, typeorm_1.InjectRepository)(entities_1.Area)),
