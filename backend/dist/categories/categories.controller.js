...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CategoriesController.prototype, "findParentCategories", null);
__decorate([
    (0, common_1.Get)('parent/:id/sub'),
...
__decorate([
    (0, common_1.Get)('sub/:id/leaf'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CategoriesController.prototype, "findLeafCategories", null);
